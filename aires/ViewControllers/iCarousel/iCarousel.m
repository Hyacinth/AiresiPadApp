...
{   
    ...
    switch (_type)
    {
        ...
        {
            CGFloat spacing = [self valueForOption:iCarouselOptionSpacing withDefault:1.2f];

            NSInteger count = [self valueForOption:iCarouselOptionCount withDefault:20.0f];
            CGFloat arc = [self valueForOption:iCarouselOptionArc withDefault:M_PI*3.0];
            ...
            return CATransform3DTranslate(transform, offset * _itemWidth * spacing, 0.0f, radius * cos(angle) - radius);
        }
